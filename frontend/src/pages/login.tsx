...
function Login({ busy, errorMessage, onAuthenticate }: LoginProps) {
        ...
        <div className="flex flex-col items-center mb-12">
          <div className="mb-6 relative">
            ...
            <div className="absolute -top-2 -right-2 w-8 h-8 bg-secondary-container rounded-full flex items-center justify-center transform -rotate-12 border-4 border-background">
              <span
                className="material-symbols-outlined text-on-secondary-container text-xs"
                style={{ fontVariationSettings: "'FILL' 1" }}
              >
                star
              </span>
          ...
          <p className="text-on-surface-variant text-sm font-medium">
            Sign in and jump straight into a live match.
          </p>
        </div>
        ...
        <div className="glass-card p-8 rounded-xl shadow-[40px_0_40px_rgba(43,42,81,0.06)] border border-outline-variant/15">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              disabled={busy}
              type="submit"
              className="w-full flex items-center justify-center gap-3 bg-gradient-to-br from-primary to-primary-container text-on-primary py-4 px-6 rounded-full font-bold shadow-lg hover:brightness-110 active:scale-95 transition-all duration-150 mt-6 disabled:opacity-70 disabled:cursor-wait"
            >
              <span>
